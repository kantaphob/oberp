...
import {
  Users, Plus, Search, Edit2, Trash2, X, Shield, Mail, CheckCircle, AlertCircle, EyeOff, Eye, Building2, ChevronLeft, ChevronRight, Fingerprint, Wand2
} from "lucide-react";
    ...
    <div className="flex flex-col h-full bg-slate-50 p-6 rounded-3xl font-sans min-h-[600px] relative">
      ...
      {loading ? (
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          <p className="text-slate-500 mt-4 text-sm font-medium animate-pulse">Loading users...</p>
        </div>
      ) : (
            ...
            >
              <div className="flex px-6 py-4 border-b border-slate-100 bg-slate-50/50 justify-between items-center shrink-0">
                <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                  ...
                  {modalMode === "EDIT" ? "Edit User Account" : "Create New User"}
                </h3>
